<title>Visitor's Log System | Administrator records</title>
                 ...
                 <table id="example11" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                    ...
                    <tr>
                        ...
                        <td><?= $row['gender'] ?></td>
                        <td><?php echo ucwords($row['email']); ?> <br> <span class="text-info"><?php if($row['contact'] !== '') { echo '+63 '.$row['contact']; } ?></span></td>
                        <td>
                          <?php if($row['user_type'] == 'Admin'): ?>
                                <span class="badge badge-info p-1"><?php echo $row['user_type']; ?></span>-<span class="badge badge-warning p-1"><?php echo $row['college_name']; ?></span>
                          <?php else: ?>
