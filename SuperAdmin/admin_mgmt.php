<title>Visitor's Log System | Administrator info</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 p-0">
                          <div class="col-lg-7 col-md-7 col-sm-12 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>College name</b></span>
                              <select class="form-control" name="college_name" required>
                                <option selected disabled value="">Select college</option>
                                <option value="CABA">COLLEGE OF ACCOUNTACY AND BUSINESS ADMINISTRATION (CABA)</option>
                                <option value="CAF">COLLEGE OF AGRICULTURE AND FORESTRY (CAF)</option>
                                ...
                                <option value="CTE">COLLEGE OF TEACHERS EDUCATION (CTE)</option>
                                <option value="CTHM">COLLEGE OF TOURISM AND HOSPITALITY MANAGEMENT (CTHM)</option>
                                <option value="GATE">PRMSU GATE ADMIN</option>
                                <option value="REGISTRAR">REGISTRAR BUILDING</option>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              ...
                              <p class="help-block text-danger">Max. 3MB</p>
                            </div>
                        </div>
                         <!-- LOAD IMAGE PREVIEW -->
                  ...
                  <div class="row">
                      ...
                      <div class="col-12 p-0">
                        <div class="col-lg-4 col col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              <?php
                                $colleges = ['CABA', 'CAF', 'CAS', 'CCIT', 'CIT', 'COE', 'CON', 'CTE', 'CTHM', 'GATE', 'REGISTRAR', 'ADMIN'];
                                $selectedcolleges = $row['college_name'];
                              ?>
                              <span class="text-dark"><b>College name</b></span>
                              <select class="form-control" name="college_name" required>
                                <option selected disabled value="">Select college</option>
                                <?php foreach ($colleges as $college): ?>
                                  <option value="<?php echo $college; ?>" <?php if ($selectedcolleges === $college) { echo 'selected'; } ?>><?php echo $college; ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>
                        </div>
