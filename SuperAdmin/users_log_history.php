...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h3>System User's Log</h3>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
            <li class="breadcrumb-item active">System User's Log history</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="card-body p-3">
              ...
              <?php 
                if(isset($_POST['daily'])) {
                  ...
                  $sql = mysqli_query($conn, "SELECT * FROM log_history 
                          JOIN users ON log_history.user_Id=users.user_Id 
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b>SYSTEM USER'S LOG HISTORY ON <?= strtoupper(date("F d, Y", strtotime($dailyDate))); ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        ...
                        <th>ADMIN NAME</th>
                        <th>COLLEGE</th>
                        <th>DATETIME LOGIN</th>
                        <th>DATETIME LOGOUT</th>
                      </tr>
                    </thead>
                    <tbody id="users_data">
                      <?php
                      ...
                      <tr>
                        ...
                        <td><?= ucwords($row['college_name']) ?></td>
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b>SYSTEM USER'S LOG HISTORY BETWEEN <?= strtoupper(date("F d, Y", strtotime($weeklyStartDate))).' - '.strtoupper(date("F d, Y", strtotime($weeklyEndDate))); ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        <th>#</th>
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b>SYSTEM USER'S LOG HISTORY ON THE MONTH OF <?= strtoupper(date("F", strtotime("$currentYear-$monthlyMonth-01"))) . " $currentYear"; ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        <th>#</th>
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b>SYSTEM USER'S LOG HISTORY ON THE YEAR <?= $yearlyDate ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        <th>#</th>
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b>SYSTEM USER'S LOG HISTORY BETWEEN <?= strtoupper(date("F d, Y", strtotime($StartDate))).' - '.strtoupper(date("F d, Y", strtotime($EndDate))); ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        <th>#</th>
              ...
              <table id="example11" class="table table-bordered table-hover table-sm text-sm">
                ...
                <tbody id="users_data">
                  ...
                  $sql = mysqli_query($conn, "SELECT * FROM log_history 
                                      JOIN users ON log_history.user_Id=users.user_Id 
                                      WHERE users.user_type != 'Superadmin' 
                                      ORDER BY log_Id DESC");
                  while ($row = mysqli_fetch_array($sql)) {
                  ?>
                  <tr>
