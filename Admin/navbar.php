        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- <li class="nav-item">
            <a href="#" class="nav-link 
              <?php //(in_array(basename($_SERVER['PHP_SELF']), ['admin.php', 'admin_mgmt.php', 'admin_view.php', 'visitors.php', 'visitors_mgmt.php', 'visitors_view.php']) ? 'active' : '') ?> "><i class="fa-solid fa-users-gear"></i><p>&nbsp;&nbsp;System Users<i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview"
              <?php //(in_array(basename($_SERVER['PHP_SELF']), ['admin.php', 'admin_mgmt.php', 'admin_view.php', 'visitors.php', 'visitors_mgmt.php', 'visitors_view.php']) ? 'style="display: block;"' : '') ?>
            >
              <li class="nav-item">
                <a href="admin.php" class="nav-link <?php //(in_array(basename($_SERVER['PHP_SELF']), ['admin.php', 'admin_mgmt.php', 'admin_view.php']) ? 'active' : '') ?>"><i class="far fa-circle nav-icon"></i><p>&nbsp;&nbsp; Administrator records</p></a>
              </li>
              <li class="nav-item">
                <a href="visitors.php" class="nav-link <?php //(in_array(basename($_SERVER['PHP_SELF']), ['visitors.php', 'visitors_mgmt.php', 'visitors_view.php']) ? 'active' : '') ?>"><i class="far fa-circle nav-icon"></i><p>&nbsp;&nbsp; Visitor records</p></a>
              </li>
            </ul>
          </li> -->
