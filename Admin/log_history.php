            ...
            <div class="card-body p-3">
                ...
                if(isset($_POST['daily'])) {
                  ...
                  $sql = mysqli_query($conn, "SELECT * FROM visitors_log_history 
                          ...
                          WHERE (DATE(login_time) = '$selectedDate' 
                             ...
                             AND (visitors_log_history.login_college_name='$college_name' || visitors_log_history.logout_college_name='$college_name')
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  <div class="row d-flex justify-content-center">
                    ...
                    <?php if($college_name != 'GATE' || $college_name != 'REGISTRAR' || $college_name != 'ADMIN'): ?>
                    <div class="col-lg-1 col-md-1 col-sm-3">
                      <img src="<?php echo $logo ?>" class="img-fluid" alt="" width="80" style="top: 5px;">
                    </div>
                    <?php endif; ?>
                  </div>
                  <hr>
                  <p class="text-center"><b><?= $college_name ?> VISITOR'S LOG HISTORY ON <?= strtoupper(date("F d, Y", strtotime($dailyDate))); ?></b></p>
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b><?= $college_name ?> VISITOR'S LOG HISTORY BETWEEN <?= strtoupper(date("F d, Y", strtotime($weeklyStartDate))).' - '.strtoupper(date("F d, Y", strtotime($weeklyEndDate))); ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        <th>#</th>
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b><?= $college_name ?> VISITOR'S LOG HISTORY ON THE MONTH OF <?= strtoupper(date("F", strtotime("$currentYear-$monthlyMonth-01"))) . " $currentYear"; ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        <th>#</th>
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b><?= $college_name ?> VISITOR'S LOG HISTORY ON THE YEAR <?= $yearlyDate ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        <th>#</th>
              ...
              <?php if(mysqli_num_rows($sql) > 0) { ?>
                ...
                <div id="printElement">
                  ...
                  <hr>
                  <p class="text-center"><b><?= $college_name ?> VISITOR'S LOG HISTORY BETWEEN <?= strtoupper(date("F d, Y", strtotime($StartDate))).' - '.strtoupper(date("F d, Y", strtotime($EndDate))); ?></b></p>
                  <table id="example111" class="table table-bordered table-hover text-sm table-sm">
                    <thead>
                      <tr>
                        <th>#</th>
              ...
              <table id="example11" class="table table-bordered table-hover table-sm text-sm">
                ...
                <tbody id="users_data">
                  <?php
                  $i = 1;
                  $sql = mysqli_query($conn, "SELECT * FROM visitors_log_history JOIN visitors ON visitors_log_history.Id=visitors.Id WHERE (visitors_log_history.login_college_name='$college_name' || visitors_log_history.logout_college_name='$college_name') ORDER BY log_Id DESC");
                  while ($row = mysqli_fetch_array($sql)) {
                  ?>
                  <tr>
                    <td><?= $i++; ?></td>
