  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h3>Visitors at <span class="text-primary"><b><?= $college_name ?></b></span></h3>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                      ...
                      <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                              <div class="input-group">
                                  ...
                                  <input type="hidden" class="form-control" name="college_name" required value="<?= $college_name ?>" id="college_name">
                 ...
                 <table id="example11" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM visitors WHERE college_name='$college_name'");
  ...
  $(document).ready(function () {
    ...
    $('#registration-filter').on('change', function () {
        ...
        $.ajax({
            url: 'ajax.php',
            type: 'POST',
            data: { filter: selectedFilter, college_name: college_name },
            dataType: 'json',
