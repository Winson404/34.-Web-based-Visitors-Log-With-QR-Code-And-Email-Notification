        ...
        <div class="row">
          <div class="col-md-12">
            <form action="process_save.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" class="form-control" name="college_name" required value="<?= $college_name ?>">
              <div class="card">
                <div class="card-body">
                    <div class="row text-muted">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control"  placeholder="Middle name" name="middlename" onkeyup="lettersOnly(this)" required>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
              ...
              <div class="card-body">
                <div class="row text-muted">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                      <div class="form-group">
                          <label for="">Middle name</label>
                          <input type="text" class="form-control"  placeholder="Middle name" name="middlename" onkeyup="lettersOnly(this)" value="<?= $row['middlename']; ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            <label for="">Age</label>
                            <input type="number" class="form-control" placeholder="Age" required name="age" id="age-input" value="<?= $row['age']; ?>" onchange="updateSeniorOptionVisibility()">
                            <p id="age-error" class="text-danger text-danger text-xs font-italic"></p>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6 col-sm-6 col-12">
