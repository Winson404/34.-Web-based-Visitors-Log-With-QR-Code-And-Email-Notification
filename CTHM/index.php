...
<body class="hold-transition layout-top-nav">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white" style="opacity:.8">
      <div class="container">
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
          <li class="nav-item">
            <a href="session_unset.php" class="nav-link"><img src="../images/cthm.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: 1">Admin login</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="row d-flex justify-content-center" style="margin: 10px 10px 5px 10px;">
      ...
      <div class="col-1">
      <img src="../images/cthm.png" alt="CAS Logo" class="img-fluid d-block m-auto">
      </div>
    </div>

    <div class="lockscreen-logo">
      <a href="index.php" class="text-light" style="font-weight: bold;">WELCOME<br>TO<br>
      <span class="text-primary">COLLEGE OF TOURISM AND HOSPITALITY MANAGEMENT</span>
      </a>
    </div>
