...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../images/systemlogo.png" alt="BMSLogo" height="105" width="105">
  </div> 
          ...
          success: function(response) { 
            ...
            // }).then(() => {
              ...
              <?php if($row['user_type'] == 'Admin'): ?>
                window.location = "../logout.php?college_name=<?= $college ?>";
              <?php else: ?>
